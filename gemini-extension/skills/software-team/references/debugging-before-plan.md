...
Spawn `researcher` with these steps as its `Task:` (it holds `run_shell_command` for
...
this PLAN spawns `tdd-builder`, not the general builder — the regression test IS its
