...
`software-team:verifier` does **not** get framework skills by default. Its loyalty is to
the acceptance criteria and the diff; a style guide loaded into it turns into invented
